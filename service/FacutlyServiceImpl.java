...
public class FacutlyServiceImpl implements FacultyService {

    private FacultyRepository repository;


    public FacutlyServiceImpl(FacultyRepository repository) {
    ...
    public Faculty retrieFaculty(String key) {
        return new Faculty(this.repository.retrieFaculty(key));
    }
